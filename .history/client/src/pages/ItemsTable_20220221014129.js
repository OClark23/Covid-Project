  ...
  render() {
    ...
    },
    {
      ...
      },
      {
        ...
        Cell: props => {
          return (
           // <Link data-update-id={props.original.patient_id} to={`/item/patient-info/${props.original.patient_id}`}>
             //  ...
            //</Link>
            return <span data-gender={props.original.patient_id}>{props.value}</span>;
          );
        },
      },
      {
