        ...
        {(items || []).length > 0
          ? items.map(item => (
              <ItemContainer key={item._id}>
                ...
                <DetailParagraph> <FaIdCard/> Patient ID: {item.PATIENT_ID}</DetailParagraph>
                ...
                <FaPenSquare/>
                  ...
                  <Link data-patient-id={item._id} to={`/item/patient-info/${item.patient_id}`}>{item.patient_id}</Link>
                  <FaTrash/> 
