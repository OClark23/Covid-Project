    ...
    return (
        _id && (
          <div className="ItemPage">
            <h1 className="title"><FaInfoCircle></FaInfoCircle>Patient Info</h1><div className="ItemContainer">
              <div className="ItemPatient">
                <h1 className="card-title"><FaHospitalUser/>  Patient</h1>
              ...
              <div className="ItemPatient">
                <h1 className="card-title"><FaXRay/>  Exam History</h1>
