  ...
  render() {
    ...
    },
    {
      ...
      },
      {
        ...
        Cell: props => {
          return (
           <Link data-patient-id={props.original.patient_id} to={`/item/patient-info/${props.original.patient_id}`}>
              <span data-priority={props.original.patient_id}>{props.value}</span>;
            </Link>
          //  <span data-patient-id={props.original.patient_id}>{props.value}</span>
          );
        },
      },
      {
