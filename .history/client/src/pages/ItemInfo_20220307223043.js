          ...
          <div className="ItemPage">
            <h1 className="title">Patient Info</h1><div className="ItemContainer">
              ...
              <div className="ItemPatient">
                ...
                <Link to={`/item/itemPatientExam/${_id}`}><h1 className="examLink">Exam #1</h1> </Link>
                <div className="ExamPhoto">
                <img src={`https://ohif-hack-diversity-covid.s3.amazonaws.com/covid-png/${IMAGES[0]}` style}></img>
                </div>
              </div>
            </div>
