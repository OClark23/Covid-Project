          ...
          ? items.map(item => (
              <ItemContainer key={item._id}>
                ...
                <ButtonsWrapper>
                  ...
                  <Link id={item.patient_id} to={`/item/patient-info/${item.patient_id}`}><span data-patient_id={item.patient_id}>{item.value}</span></Link>
                  <DeleteButton id={item.patient_id} onDelete={this.handleRemoveItem} />
                </ButtonsWrapper>
              </ItemContainer>
            ))
          : `No items to render... :(`}
