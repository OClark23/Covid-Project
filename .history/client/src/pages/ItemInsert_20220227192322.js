...
class ItemInsert extends Component {
  ...
  handleInsertItem = event => {
    ...
    const { name, gender, age, patient_id, zip, daysOfWeek, timeframeNote, priority, content } = this.state;
    const item = { name, gender, age, patient_id, zip, daysOfWeek, timeframeNote, priority, content};
  ...
  render() {
    ...
    return (
      ...
      <br />
        ...
        <Label> Age:</Label>
        <InputText type="number" min="18" max="100" value={this.state.age}  onChange={this.handleChangeInputAge} />
